...
/// Provider for the ImagesApi instance.
...
/// Provider for the UsersApi instance.
...
/// Provider for the WatchingsApi instance.
final watchingsApiProvider = Provider<WatchingsApi>((ref) {
  final api = ref.read(mindwellApiProvider);
