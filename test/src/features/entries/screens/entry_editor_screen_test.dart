...
void main() {
  group('EntryEditorScreen', () {
    ...
    Widget createWidget({int? entryId, String? themeName}) {
      return ProviderScope(
        ...
        child: MaterialApp(
          ...
          home: EntryEditorScreen(entryId: entryId, themeName: themeName),
        ),
      );
    }

    testWidgets('displays correct title for new personal entry', (
      tester,
    ) async {
    ...
    testWidgets('displays correct title for editing existing entry', (
      tester,
    ) async {
      // Set the state to editing
      mockNotifier.state = const EntryEditorState.editing(
