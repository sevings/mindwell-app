...
void main() {
  group('CalendarCard', () {
    ...
    testWidgets('should hide year when displaying current year', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget(calendarData: mockCalendar));
      await tester.pumpAndSettle();
    ...
    testWidgets('should show popup with constrained width for multiple entries', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget(calendarData: mockCalendar));
      await tester.pumpAndSettle();
    ...
    testWidgets('should not navigate before profile registration date', (WidgetTester tester) async {
    ...
    testWidgets('should work with entries in current month', (WidgetTester tester) async {
      ...
      final currentMonthEntries = [
        MwCalendarEntry((b) => b
          ...
          ..createdAt = DateTime(currentMonth.year, currentMonth.month, 15).millisecondsSinceEpoch / 1000.0),
      ];

      final currentMonthCalendar = MwCalendar((b) => b
        ..entries = ListBuilder<MwCalendarEntry>(currentMonthEntries)
        ..start = DateTime(currentMonth.year, currentMonth.month, 1).millisecondsSinceEpoch / 1000.0
        ..end = DateTime(currentMonth.year, currentMonth.month + 1, 0).millisecondsSinceEpoch / 1000.0
        ..limit = 100);
    ...
    testWidgets('should show popup for multiple entries in current month', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(createTestWidget(calendarData: currentMonthCalendar));
      await tester.pumpAndSettle();
    ...
    testWidgets('should navigate to registration date when previous year is blocked', (WidgetTester tester) async {
      // Create a mock profile with registration date in January 2024
      final mockProfile = $MwProfile((b) => b
        ..id = 1
        ..name = 'testuser'
    ...
    group('Edge Cases & Error Handling', () {
      testWidgets('should handle entries with null createdAt', (WidgetTester tester) async {
        ...
        final calendarWithNullCreatedAt = MwCalendar((b) => b
          ..entries = ListBuilder<MwCalendarEntry>(entriesWithNullCreatedAt)
          ..start = DateTime(2024, 1, 1).millisecondsSinceEpoch / 1000.0
          ..end = DateTime(2024, 12, 31).millisecondsSinceEpoch / 1000.0
          ..limit = 100);

        await tester.pumpWidget(createTestWidget(calendarData: calendarWithNullCreatedAt));
        await tester.pumpAndSettle();
      ...
      testWidgets('should handle profile with null registration date', (WidgetTester tester) async {
        final mockProfileWithNullCreatedAt = $MwProfile((b) => b
          ..id = 1
          ..name = 'testuser'
          ..createdAt = null);
      ...
      testWidgets('should handle malformed calendar data gracefully', (WidgetTester tester) async {
        // Create calendar with invalid date ranges
        final malformedCalendar = MwCalendar((b) => b
          ..entries = ListBuilder<MwCalendarEntry>([])
          ..start = -1.0 // Invalid start date
          ..end = -1.0   // Invalid end date
          ..limit = -1); // Invalid limit

        await tester.pumpWidget(createTestWidget(calendarData: malformedCalendar));
        await tester.pumpAndSettle();
    ...
    group('Widget Lifecycle & State Management', () {
      testWidgets('should update when calendar data changes', (WidgetTester tester) async {
        final initialCalendar = MwCalendar((b) => b
          ..entries = ListBuilder<MwCalendarEntry>([])
          ..start = DateTime(2024, 1, 1).millisecondsSinceEpoch / 1000.0
          ..end = DateTime(2024, 12, 31).millisecondsSinceEpoch / 1000.0
          ..limit = 100);

        await tester.pumpWidget(createTestWidget(calendarData: initialCalendar));
        await tester.pumpAndSettle();
        ...
        final updatedCalendar = MwCalendar((b) => b
          ..entries = ListBuilder<MwCalendarEntry>([
            MwCalendarEntry((b) => b
              ..id = 1
              ..title = 'New Entry'
        ...
        await tester.pumpWidget(createTestWidget(calendarData: updatedCalendar));
        await tester.pumpAndSettle();
      ...
      testWidgets('should maintain state when profile changes', (WidgetTester tester) async {
        final initialProfile = $MwProfile((b) => b
          ..id = 1
          ..name = 'user1'
        ...
        // Update profile
        final updatedProfile = $MwProfile((b) => b
          ..id = 2
          ..name = 'user2'
    ...
    group('Localization & Internationalization', () {
      testWidgets('should display month names in different locales', (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          MaterialApp(
            ...
            supportedLocales: AppLocalizations.supportedLocales,
            home: Scaffold(
              body: CalendarCard(calendarData: mockCalendar),
            ),
          ),
        );
        await tester.pumpAndSettle();
      ...
      testWidgets('should display day headers in different locales', (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(calendarData: mockCalendar));
        await tester.pumpAndSettle();
      ...
      testWidgets('should handle semantic labels localization', (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(calendarData: mockCalendar));
        await tester.pumpAndSettle();
    ...
    group('Popup Dialog Functionality', () {
      testWidgets('should show popup with multiple entries and allow navigation', (WidgetTester tester) async {
        MwCalendarEntry? tappedEntry;
      ...
      testWidgets('should close popup with close button', (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(calendarData: mockCalendar));
        await tester.pumpAndSettle();
      ...
      testWidgets('should handle popup with many entries (scrollable)', (WidgetTester tester) async {
        // Create calendar with many entries on the same day
        final manyEntries = List.generate(10, (index) => 
          MwCalendarEntry((b) => b
            ..id = index + 1
            ..title = 'Entry ${index + 1}'
            ..createdAt = DateTime(2024, 1, 15).millisecondsSinceEpoch / 1000.0));

        final calendarWithManyEntries = MwCalendar((b) => b
          ..entries = ListBuilder<MwCalendarEntry>(manyEntries)
          ..start = DateTime(2024, 1, 1).millisecondsSinceEpoch / 1000.0
          ..end = DateTime(2024, 12, 31).millisecondsSinceEpoch / 1000.0
          ..limit = 100);

        await tester.pumpWidget(createTestWidget(calendarData: calendarWithManyEntries));
        await tester.pumpAndSettle();
    ...
    group('Calendar Grid Edge Cases', () {
      testWidgets('should handle February in leap year', (WidgetTester tester) async {
        // Create entries for February 29, 2024 (leap year)
        final leapYearEntries = [
          MwCalendarEntry((b) => b
            ..id = 1
            ..title = 'Leap Year Entry'
            ..createdAt = DateTime(2024, 2, 29).millisecondsSinceEpoch / 1000.0),
        ];

        final leapYearCalendar = MwCalendar((b) => b
        ...
        await tester.pumpWidget(createTestWidget(calendarData: leapYearCalendar));
        await tester.pumpAndSettle();
      ...
      testWidgets('should handle months with different day counts', (WidgetTester tester) async {
        // Test February (28 days), April (30 days), January (31 days)
        final entriesForDifferentMonths = [
          MwCalendarEntry((b) => b
            ..id = 1
            ..title = 'Feb Entry'
            ..createdAt = DateTime(2024, 2, 28).millisecondsSinceEpoch / 1000.0),
          MwCalendarEntry((b) => b
            ..id = 2
            ..title = 'Apr Entry'
            ..createdAt = DateTime(2024, 4, 30).millisecondsSinceEpoch / 1000.0),
          MwCalendarEntry((b) => b
            ..id = 3
            ..title = 'Jan Entry'
            ..createdAt = DateTime(2024, 1, 31).millisecondsSinceEpoch / 1000.0),
        ];

        final multiMonthCalendar = MwCalendar((b) => b
          ..entries = ListBuilder<MwCalendarEntry>(entriesForDifferentMonths)
          ..start = DateTime(2024, 1, 1).millisecondsSinceEpoch / 1000.0
          ..end = DateTime(2024, 12, 31).millisecondsSinceEpoch / 1000.0
          ..limit = 100);

        await tester.pumpWidget(createTestWidget(calendarData: multiMonthCalendar));
        await tester.pumpAndSettle();
      ...
      testWidgets('should handle months starting on different weekdays', (WidgetTester tester) async {
    ...
    group('Navigation Edge Cases', () {
      testWidgets('should handle year boundary navigation (December to January)', (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(calendarData: mockCalendar));
        await tester.pumpAndSettle();
      ...
      testWidgets('should handle rapid navigation button tapping', (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(calendarData: mockCalendar));
        await tester.pumpAndSettle();
      ...
      testWidgets('should handle navigation limits with profile registration date', (WidgetTester tester) async {
        final profileWithRecentRegistration = $MwProfile((b) => b
          ..id = 1
          ..name = 'recentuser'
          ..createdAt = DateTime(2024, 6, 1).millisecondsSinceEpoch / 1000.0);
    ...
    group('Visual & Styling', () {
      testWidgets('should adapt to different theme configurations', (WidgetTester tester) async {
        await tester.pumpWidget(
          MaterialApp(
            theme: ThemeData(
      ...
      testWidgets('should handle very long entry titles gracefully', (WidgetTester tester) async {
        final longTitleEntry = MwCalendarEntry((b) => b
          ..id = 1
          ..title = 'This is an extremely long entry title that should be truncated properly to fit within the calendar day cell without causing layout issues or overflow problems'
          ..createdAt = DateTime(2024, 1, 15).millisecondsSinceEpoch / 1000.0);
      ...
      testWidgets('should maintain consistent styling across different months', (WidgetTester tester) async {
        await tester.pumpWidget(createTestWidget(calendarData: mockCalendar));
        await tester.pumpAndSettle();
